export const projects = [
  {
    ...
    technologiesMobile:
      'Javascript, Next.js, Tailwind CSS, NextAuth, Firebase, Recoil, Faker.js',
  },
  {
  ...
  },
  {
    ...
    technologiesMobile:
      'Javascript, Next.js, Tailwind CSS, Google Search API, SSR, Dark Mode',
  },
  {
    ...
    technologiesMobile:
      'Javascript, Next.js, NextAuth, Tailwind CSS, Firebase, SSR',
  },
  {
    title: 'Hulu Clone',
    ...
    summary:
      'Website that handles TMDb REST API to show information about movies and filter them out as required based on the selected genre.',
    technologies: ['JavaScript', 'Next.js', 'SSR', 'TMDb API', 'Tailwind CSS'],
    technologiesMobile: 'Javascript, Next.js, SSR, TMDb API, Tailwind CSS',
  },
  {
    title: 'Medium Clone',
    ...
    technologiesMobile:
      'Typescript, Next.js, NextAuth, SSR, Tailwind CSS, Sanity CMS, GROQ',
  },
]
